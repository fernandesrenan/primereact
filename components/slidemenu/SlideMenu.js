...
var SlideMenu = exports.SlideMenu = function (_Component2) {
    ...
    _createClass(SlideMenu, [{
        ...
        value: function bindDocumentClickListener() {
            ...
            if (!this.documentClickListener) {
                this.documentClickListener = function (event) {
                    if (!_this6.selfClick && _this6.container.offsetParent) {
                        _this6.hide(event);
                    }
        ...
        value: function bindDocumentResizeListener() {
            ...
            if (!this.documentResizeListener) {
                this.documentResizeListener = function (event) {
                    if (_this7.container.offsetParent) {
                        _this7.hide(event);
                    }
                };
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('ui-slidemenu ui-widget ui-widget-content ui-corner-all', { 'ui-slidemenu-dynamic ui-shadow': this.props.popup });
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        { className: 'ui-slidemenu-content', ref: function ref(el) {
                                return _this8.slideMenuContent = el;
                            } },
