...
var TieredMenu = exports.TieredMenu = function (_Component2) {
    ...
    _createClass(TieredMenu, [{
        ...
        value: function bindDocumentClickListener() {
            ...
            if (!this.documentClickListener) {
                this.documentClickListener = function (event) {
                    if (!_this5.targetClick && !_this5.selfClick) {
                        if (_this5.props.popup) {
                            _this5.hide(event);
                        }
        ...
        value: function bindDocumentResizeListener() {
            ...
            if (!this.documentResizeListener) {
                this.documentResizeListener = function (event) {
                    if (_this6.container.offsetParent) {
                        _this6.hide(event);
                    }
                };
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('ui-tieredmenu ui-widget ui-widget-content ui-corner-all', { 'ui-tieredmenu-dynamic ui-shadow': this.props.popup }, this.props.className);
