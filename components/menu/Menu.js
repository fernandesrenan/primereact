    ...
    _createClass(Menu, [{
        ...
        value: function bindDocumentListeners() {
            ...
            if (!this.documentClickListener) {
                this.documentClickListener = function (event) {
                    if (_this2.selfClick) _this2.selfClick = false;else _this2.hide(event);
                };
            ...
            if (!this.documentResizeListener) {
                this.documentResizeListener = function (event) {
                    if (_this2.container.offsetParent) {
                        _this2.hide(event);
                    }
                };
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    { href: item.url || '#', className: 'ui-menuitem-link ui-corner-all', target: item.target, onClick: function onClick(event) {
                            return _this4.itemClick(event, item);
                        } },
                    icon,
                    _react2.default.createElement(
                        'span',
        ...
        value: function renderMenu() {
            ...
            return this.props.model.map(function (item, index) {
                return _this5.renderItem(item, index);
            });
        }
    }, {
        key: 'render',
